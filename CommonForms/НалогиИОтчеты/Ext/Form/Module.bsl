...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	Если ИмяСтраницы = "Страница_НДС" Тогда
		...
		Элементы.ПодсказкаНДСПриУСН4.Заголовок = Новый ФорматированнаяСтрока(
			Новый ФорматированнаяСтрока(СтрШаблон(НСтр("ru = 'При переходе на уплату НДС по общей ставке (%1). Налог, включенный в стоимость остатков на счетах '"),
			УчетНДСКлиентСервер.ОбщаяСтавкаНДС(ДатаИзменения))),
