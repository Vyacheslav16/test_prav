...
Функция ДанныеДляРаспределенияУдержаний(ОтборФизическиеЛица, ОтборУдержания, ИсключаемыеРегистраторы, ДополнительныеПараметры) Экспорт
	...
	Если ОкончательныйРасчет Тогда
		...
		|ГДЕ
		|	РаспределениеНачислений.ВидДоходаИсполнительногоПроизводства <> ЗНАЧЕНИЕ(Перечисление.ВидыДоходовИсполнительногоПроизводства.КомпенсацииНеоблагаемыеПериодические)
		|	И РаспределениеНачислений.ВидДоходаИсполнительногоПроизводства <> ЗНАЧЕНИЕ(Перечисление.ВидыДоходовИсполнительногоПроизводства.КомпенсацииНеоблагаемыеЕдиновременные)
		|
		|СГРУППИРОВАТЬ ПО
