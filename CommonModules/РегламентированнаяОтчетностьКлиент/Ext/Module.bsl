...
Процедура ОтправитьОтчетИзФормыСписка(Форма, ИмяКоманды, КонтекстЭДОКлиент, ТекущиеДанные) Экспорт
	...
	Если ТекущиеДанныеНаименованиеОтчета = "Расчет совокупного размера выручки"
		...
		И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("совокупного размера выруч",
		'20260119') Тогда
		ПоказатьИВернутьОшибку(Форма,
			НСтр("ru = 'Отправка в электронном виде формы отчета не предусмотрена
					   |законодательством. Форма сдается в бумажном виде'"));
	...
	Если ТекущиеДанныеНаименованиеОтчета = "Бухгалтерская отчетность"
		И ТипЗнч(ТекущиеДанные.РегламентированныйОтчет) = Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
		ОписаниеРегОтчета = РегламентированнаяОтчетностьВызовСервера.ОписаниеРегОтчета(ТекущиеДанные.РегламентированныйОтчет);
		Если ОписаниеРегОтчета.ВыбраннаяФорма = "ФормаОтчета2025Кв1"
			И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.бух.отч.25к1",
			'20260101') Тогда
			ПоказатьИВернутьОшибку(Форма,
				НСтр("ru = 'Отправка в электронном виде формы отчета не предусмотрена
						   |законодательством. Форма сдается в бумажном виде'"));
	...
	Если ТекущиеДанныеНаименованиеОтчета = "Бухгалтерская отчетность упрощенная"
		И ТипЗнч(ТекущиеДанные.РегламентированныйОтчет) = Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
		ОписаниеРегОтчета = РегламентированнаяОтчетностьВызовСервера.ОписаниеРегОтчета(ТекущиеДанные.РегламентированныйОтчет);
		Если ОписаниеРегОтчета.ВыбраннаяФорма = "ФормаОтчета2025Кв1"
			И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.бух.отч.упрощ.25к1",
			'20260101') Тогда
			ПоказатьИВернутьОшибку(Форма,
				НСтр("ru = 'Отправка в электронном виде формы отчета не предусмотрена
						   |законодательством. Форма сдается в бумажном виде'"));
	...
	Если ТекущиеДанныеНаименованиеОтчета = "Декларация по УСН"
		И ТипЗнч(ТекущиеДанные.РегламентированныйОтчет) = Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
		ОписаниеРегОтчета = РегламентированнаяОтчетностьВызовСервера.ОписаниеРегОтчета(ТекущиеДанные.РегламентированныйОтчет);
		Если ОписаниеРегОтчета.ВыбраннаяФорма = "ФормаОтчета2025Кв1"
			И НЕ ОнлайнСервисыРегламентированнойОтчетностиВызовСервера.СобытиеНаступило("Отпр.декл.УСН 25к1",
			'20260115') Тогда
			ПоказатьИВернутьОшибку(Форма,
				НСтр("ru = 'Отправка в электронном виде формы отчета не предусмотрена
						   |законодательством. Форма сдается в бумажном виде'"));
