...
// Переопределяет признак того, что организация применяет АУСН и автоматически передает данные об НДФЛ в банк/ЛК ФНС.
//
// Параметры:
//   Организация - СправочникСсылка.Организации - Для чтения. Организация, для которой определяется признак.
//   Период - Дата, на которую определяется настройка.
...
Процедура ОрганизацияНаАУСНПередаетНДФЛвБанк(Организация, Период = Неопределено, ЗарегистрированоДляПередачиВБанкНаАУСН) Экспорт
	
	ЗарегистрированоДляПередачиВБанкНаАУСН = УчетнаяПолитика.ПрименяетсяАУСН(Организация, Период);
