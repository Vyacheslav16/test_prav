...
//	КонецЕсли;
//	
//	Форма = ПолучитьФорму("Документ.АР_СчетНаАренду.Форма.ФормаДокумента");
...
//	
//	Если ТипЗнч(Основание) = Тип("ДокументСсылка.АР_ЗаключениеДоговораАренды")Тогда
//		
//		//Пар = Новый Структура("ВидОперации", ВидОперации);
//		Форма = ПолучитьФорму("Документ.АР_ДополнительноеСоглашение.Форма.ФормаДокумента");
//		Если Форма.Открыта() Тогда
//			Форма.Активизировать();
//		Иначе 
//			ДанныеФормы = Форма.Объект;
