...
Процедура УстановитьОформлениеСтроки(Строка)
	...
	Если Строка.Оформление.Получить("ВидНачисленияЗарплата") <> Неопределено Тогда
		ВидимостьЗарплаты = НачисленоДивиденды = 0 И КВыплатеДивиденды = 0 И ВыплаченоДивиденды = 0 И НДФЛДивиденды = 0
			И НачисленоДоговоры = 0 И КВыплатеДоговоры = 0 И ВыплаченоДоговоры = 0;
		Строка.Оформление["ВидНачисленияЗарплата"].УстановитьЗначениеПараметра ("Видимость", Не ВидимостьЗарплаты);
	КонецЕсли;

	ВидимостьДивидендов = НачисленоДивиденды = 0 И КВыплатеДивиденды = 0 И ВыплаченоДивиденды = 0 И НДФЛДивиденды = 0;
	
	Если Строка.Оформление.Получить("ВидНачисленияДивиденды") <> Неопределено Тогда
		Строка.Оформление["ВидНачисленияДивиденды"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДивидендов);
	КонецЕсли;
	Если Строка.Оформление.Получить("НачисленоДивиденды") <> Неопределено Тогда
		Строка.Оформление["НачисленоДивиденды"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДивидендов);
	КонецЕсли;
	Если Строка.Оформление.Получить("КВыплатеДивиденды") <> Неопределено Тогда
		Строка.Оформление["КВыплатеДивиденды"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДивидендов);
	КонецЕсли;
	Если Строка.Оформление.Получить("ВыплаченоДивиденды") <> Неопределено Тогда
		Строка.Оформление["ВыплаченоДивиденды"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДивидендов);
	КонецЕсли;
	Если Строка.Оформление.Получить("НДФЛДивиденды") <> Неопределено Тогда
		Строка.Оформление["НДФЛДивиденды"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДивидендов);
	КонецЕсли;
	
	ВидимостьДоговоров = НачисленоДоговоры = 0 И КВыплатеДоговоры = 0 И ВыплаченоДоговоры = 0;
	
	Если Строка.Оформление.Получить("ВидНачисленияДоговоры") <> Неопределено Тогда
		Строка.Оформление["ВидНачисленияДоговоры"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДоговоров);
	КонецЕсли;
	Если Строка.Оформление.Получить("НачисленоДоговоры") <> Неопределено Тогда
		Строка.Оформление["НачисленоДоговоры"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДоговоров);
	КонецЕсли;
	Если Строка.Оформление.Получить("КВыплатеДоговоры") <> Неопределено Тогда
		Строка.Оформление["КВыплатеДоговоры"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДоговоров);
	КонецЕсли;
	Если Строка.Оформление.Получить("ВыплаченоДоговоры") <> Неопределено Тогда
		Строка.Оформление["ВыплаченоДоговоры"].УстановитьЗначениеПараметра("Видимость", Не ВидимостьДоговоров);
	КонецЕсли;
