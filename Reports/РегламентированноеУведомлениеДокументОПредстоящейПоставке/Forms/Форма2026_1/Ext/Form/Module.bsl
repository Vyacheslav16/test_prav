...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "НДССт" И Не ЭтотОбъект["РучнойВвод"] Тогда
		СтандартнаяОбработка = Ложь;
		ВыборСтавкиНДС();
	ИначеЕсли Область.Имя = "ПодборПервичногоДокумента" Тогда 
		...
		Если ПрСпецТов = "1" Тогда 
			Для Каждого Элт1 Из ЭтотОбъект["ДанныеМногостраничныхРазделов"].Спецификация Цикл 
				...
				Для Каждого Элт2 Из ЭтотОбъект["ДанныеМногостраничныхРазделов"].ТоварСпецификация Цикл 
					...
					СумОбПлат = СумОбПлат + ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Товар, "СумНДС", 0)
						+ ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Товар, "СумАкцизТв", 0)
						+ ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Товар, "СумАкцизАдв", 0);
				КонецЦикла;
			КонецЦикла;
